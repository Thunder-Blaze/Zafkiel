		...
		return [
			{
				...
				peers: 10,
				magnet:
					'magnet:?xt=urn:btih:EXAMPLE_HASH&dn=Example+Video&tr=udp://tracker.opentrackr.org:1337/announce',
				provider: 'Nyaa.si',
			...
			},
			{
				...
				peers: 5,
				magnet:
					'magnet:?xt=urn:btih:EXAMPLE_HASH_2&dn=Example+Video+2&tr=udp://tracker.opentrackr.org:1337/announce',
				provider: 'Nyaa.si',
				uploadedAt: '2024-01-01',
			},
		];
