	...
	{:else}
		...
		<section>
			<div class="mb-4 flex items-center justify-between">
				...
				<button onclick={() => goto('/search/characters/all?section=birthday')} class="flex items-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground">
			...
			{:else}
				<div class="overflow-hidden">
					<div class="-mb-5 p-0.5 grid gap-5 grid-cols-[repeat(auto-fill,minmax(10rem,1fr))] grid-rows-[repeat(2,auto)] auto-rows-[0px]">
		...
		<section>
			<div class="mb-4 flex items-center justify-between">
				...
				<button onclick={() => goto('/search/characters/all')} class="flex items-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground">
					View All <Icon icon="solar:arrow-right-linear" class="h-3.5 w-3.5" />
				</button>
			</div>
