...
export const DEMOGRAPHICS = ['Josei', 'Kids', 'Seinen', 'Shoujo', 'Shounen'];
...
export const ADVANCED_TAGS = {
	...
	'Theme / Sci Fi': ['Cyberpunk', 'Space Opera', 'Time Loop', 'Time Manipulation', 'Tokusatsu'],
