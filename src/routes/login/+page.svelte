...
<div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-muted/20 p-4">
	<div class="w-full max-w-md space-y-8">
		<!-- Logo/Brand Section -->
		<div class="text-center">
			<div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 ring-2 ring-primary/20">
		...
		<Card class="border-2 shadow-2xl">
			<CardHeader class="space-y-1 text-center">
				...
				<CardDescription>
					Sign in with your AniList account to continue
				</CardDescription>
			</CardHeader>
			<CardContent class="space-y-6">
				...
				<!-- Error Message -->
				{#if errorMessage}
					<div class="rounded-lg bg-destructive/10 border border-destructive/20 p-4 text-sm text-destructive flex items-start gap-2">
						<Icon icon="solar:danger-circle-bold" class="h-5 w-5 flex-shrink-0 mt-0.5" />
						<p>{errorMessage}</p>
					</div>
				{/if}
					...
					<ul class="space-y-3">
						<li class="flex items-start gap-3">
							...
							<div class="text-sm">
								...
								<p class="text-muted-foreground text-xs">Keep track of what you're watching</p>
							</div>
						</li>
						<li class="flex items-start gap-3">
							<div class="mt-0.5 rounded-full bg-primary/10 p-1">
							...
							<div class="text-sm">
								...
								<p class="text-muted-foreground text-xs">Discover new anime based on your taste</p>
							</div>
						</li>
						<li class="flex items-start gap-3">
							<div class="mt-0.5 rounded-full bg-primary/10 p-1">
							...
							<div class="text-sm">
								...
								<p class="text-muted-foreground text-xs">Access your data anywhere</p>
							</div>
						</li>
					</ul>
				</div>
				...
				<!-- Privacy Note -->
				<div class="rounded-lg bg-muted/50 p-3 text-xs text-muted-foreground text-center">
					<Icon icon="solar:shield-check-bold" class="inline-block h-4 w-4 mr-1" />
