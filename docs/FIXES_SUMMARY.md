...
<div class="absolute inset-0">
	...
	<div
		class="absolute inset-0 bg-gradient-to-br from-background/95 via-background/60 to-background/80"
	></div>
</div>
```
...
<Card class="border-border/50 bg-card/60 p-4 backdrop-blur-md">
